...
function App() {
  ...
  return (
    // etapa II de utilização do Context API: criação do "Provider". Os "values" serão consumidos pelos componentes dentro do Context, no caso <ListaTarefas /> e <Login />
    <UserContext.Provider value={{usuario, setUsuario}}>
      <main>
        
        {/* chamada do componente ListaTarefas que contém o antigo código que estava aqui */}
        {/* expressão criada para verificar se o usuário está logado. Se sim, então a Liista de Tarefas será renderizada. Caso contrário, o Login será renderizado */}
...
// ANTIGO APP QUE FOI LEVADO E TRANSFORMADO PARA "ListaTarefas" NO ARQUIVO "ListaTarefas.jsx"
...
//     const nova = { texto: tarefa.valor.trim()}
